...
from crawler.sports_reference.basketball import player_page_parser
...
class TestPlayerPageParser(unittest.TestCase):
    ...
    def test_birthday_text_to_date(self):
        parser = player_page_parser.PlayerPageParser("")
    ...
    def test_parser(self):
        ...
        parser = player_page_parser.PlayerPageParser(page)
